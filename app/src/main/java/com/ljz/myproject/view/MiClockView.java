...
import com.ljz.myproject.utils.DensityUtils;
import java.util.Calendar;

/**
 * Created by Welive on 2018/12/12.
 * 仿小米时钟
 */
...
public class MiClockView extends View {
    ...
    public MiClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float mTextSize = ta.getDimension(R.styleable.MiClockView_textSize, DensityUtils.sp2px(context, 14));
        ta.recycle();
