...
public class SideBarView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.SideBarView);
            scaleSize = ta.getInteger(R.styleable.SideBarView_scaleSize, 1);
            scaleItemCount = ta.getInteger(R.styleable.SideBarView_scaleItemCount, 6);
            scaleWidth = ta.getDimensionPixelSize(R.styleable.SideBarView_scaleWidth, dp(100));
            ta.recycle();
        }
